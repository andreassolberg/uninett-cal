define(function(require, exports, module) {
	...
	var SeasonSelector = function(el) {
		var that = this;
		...
		this.el.on('click', '.pick1', function(e) {
			e.preventDefault();
		...
		this.el.on('click', '.pick2', function(e) {
			e.preventDefault();
			var ct = $(e.currentTarget);
			var cc = $(e.currentTarget).parent("#seasonpicker");
			cc.children().removeClass("active");
		...
		this.el.on('click', '.pick3', function(e) {
			e.preventDefault();
			var ct = $(e.currentTarget);
			var cc = $(e.currentTarget).parent("#seasonpicker");
			cc.children().removeClass("active");
	...
	SeasonSelector.prototype.getPeriod = function(week, day) {
		...
		var x = Event.getNow().clone().startOf('year')
			.startOf('week')
